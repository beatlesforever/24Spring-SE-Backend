...
public class EnergyConsumptionController {
     ...
     */
    @GetMapping("/{roomId}{queryTime}")
    public ResponseEntity<Map<String, Object>> getRoomCost(@PathVariable int roomId, @PathVariable LocalDateTime queryTime) {
        ...
        // 如果有正在进行的温控请求，计算当前累积能耗和费用
            ...
            float duration = (float) (queryTime.getMinute() - requestTime.getMinute()) ;
            // 计算当前累积能耗
            ...
            float currentEnergyConsumed = energyConsumed + duration;
            // 计算当前累积费用，一个单位能耗对应5元
